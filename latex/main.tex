...
\titleformat{\section}[hang]{\large\bfseries}{\textcolor{unipd}{\thesection}\hsp\textcolor{gray75}{|}\hsp}{0pt}{\large\bfseries\textcolor{gray25}}[\color{unipd}{\titlerule[1.0pt]}]
    ...
    \input{sections/temporal_epidemics.tex}   % Theoretical project: epidemics on temporal networks
    %\input{sections/internet_as_bgp.tex}  % Data project: BGP AS-level network (TODO)
