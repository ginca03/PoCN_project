...
& \begin{minipage}{0.77\textwidth}\textcolor{unipd}{\textbf{\LARGE Epidemics on temporal networks \&\ the AS-level Internet from BGP}}\end{minipage}\\
& \\
& \textbf{Venturato, Giancarlo}\\
& \\
& \\
