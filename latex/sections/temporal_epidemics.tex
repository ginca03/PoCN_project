...
$p$ each step, so the aggregate is the backbone itself. As a real-world test (a
``plus'' in the brief) we additionally use the empirical \emph{SocioPatterns
Hypertext~2009} face-to-face contact network~\cite{isella2011whats} ($113$
